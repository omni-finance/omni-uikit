...
export const TokenImages: React.FC = () => {
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        const src = `https://omniswap.space/images/tokens/${token.address[56]}.svg`;
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        ...
        const primarySrc = `https://omniswap.space/images/tokens/${token.address[56]}.svg`;
        const secondarySrc = `https://omniswap.space/images/tokens/${tokens[randomTokenIndex].address[56]}.svg`;
